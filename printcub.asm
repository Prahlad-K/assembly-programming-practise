...
;mov y1, 100
;mov y2, 200
;call disverline -invisible
; printing square1 completed.
...
;mov x2, 210
;mov y2, 210
;call disleftdiagline -invisible

;connecting the squares, completing the cube. :)
